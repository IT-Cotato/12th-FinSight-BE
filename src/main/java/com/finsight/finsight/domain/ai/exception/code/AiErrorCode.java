...
public enum AiErrorCode implements BaseErrorCode {
    ...
    OPENAI_SERVER_ERROR(HttpStatus.BAD_GATEWAY, "OpenAI 서버 오류가 발생했습니다.", "AI-010"),
    OPENAI_TIMEOUT(HttpStatus.GATEWAY_TIMEOUT, "OpenAI 응답 시간이 초과되었습니다.", "AI-011"),

    // OpenAI - 재시도 불가 (SUSPENDED) - 쿼터/결제/인증
    OPENAI_QUOTA_EXHAUSTED(HttpStatus.PAYMENT_REQUIRED, "OpenAI API 크레딧이 소진되었습니다.", "AI-020"),
    OPENAI_INSUFFICIENT_BALANCE(HttpStatus.PAYMENT_REQUIRED, "OpenAI 계정 잔액이 부족합니다.", "AI-021"),
    OPENAI_INVALID_API_KEY(HttpStatus.UNAUTHORIZED, "OpenAI API 키가 유효하지 않습니다.", "AI-022"),
    OPENAI_ACCESS_DENIED(HttpStatus.FORBIDDEN, "OpenAI API 접근이 거부되었습니다.", "AI-023"),

    // OpenAI - 재시도 불가 (FAILED) - 잘못된 요청/파싱
    OPENAI_INVALID_REQUEST(HttpStatus.BAD_REQUEST, "OpenAI 요청 형식이 잘못되었습니다.", "AI-024"),
    OPENAI_RESPONSE_PARSE_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, "OpenAI 응답 파싱에 실패했습니다.", "AI-030"),
